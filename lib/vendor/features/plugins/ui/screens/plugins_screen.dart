          ...
          Expanded(
            child: SingleChildScrollView(
              child: Padding(
                ...
                child: Column(
                  children: [
                    const CustomHeaderTextWidget(text: 'Zoom'),
                    const SizedBox(height: 24),
                    const CustomTextField(headerText: 'Account ID*'),
                    const SizedBox(height: 16),
                    const CustomTextField(headerText: 'Client ID*'),
                    const SizedBox(height: 16),
                    const CustomTextField(headerText: 'Client Secret*'),
                    const SizedBox(height: 16),
                    SizedBox(
                      height: 52,
                      child: CustomButtonWidget(
                        ...
                        onPressed: () {
                          CustomSnackBar.show(
                            ...
                            context,
                            'Zoom info updated successfully!',
                          );
                        },
                        fontSize: 16,
                      ),
                    ...
                    const SizedBox(height: 24),
                    const CustomHeaderTextWidget(text: 'Google Calender'),
                    const SizedBox(height: 24),
                    const CustomHeaderTextWidget(text: 'Upload Your File*',fontSize: 16,fontWeight: FontWeight.w500,),
