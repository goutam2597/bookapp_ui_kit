            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  _infoText('Title', 'Platinum'),
                  _infoText('Term', 'Lifetime'),
                  _infoText('Start Date', 'Oct-29-2024'),
                  _infoText('Expire Date', 'Lifetime'),
                  _infoText('Purchase Type', 'Regular'),
                  const SizedBox(height: 8),
                ],
              ),
            ),
