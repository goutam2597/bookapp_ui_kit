...
import 'package:book_app/staff/features/staff_appointment/ui/screens/staff_appointment_details_screen.dart';
      ...
      child: InkWell(
        ...
        onTap: () {
          Navigator.push(
            ...
            MaterialPageRoute(
              builder: (context) =>
                  StaffAppointmentDetailsScreen(booking: booking),
            ),
          );
        },
        child: Padding(
