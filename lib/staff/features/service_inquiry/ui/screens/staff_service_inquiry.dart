...
class StaffServiceInquiry extends StatefulWidget {
  const StaffServiceInquiry({super.key});

  @override
  State<StaffServiceInquiry> createState() => _StaffServiceInquiryState();
}

class _StaffServiceInquiryState extends State<StaffServiceInquiry> {
